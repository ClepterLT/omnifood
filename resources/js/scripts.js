$(document).ready(function () {
    ...
    $('.js--mobile-nav-icon').click(function() {
        ...
        var icon = $('ion-icon')
        var iconlines = $('.js--mobile-menu-lines');
        var iconclose = $('.js--mobile-menu-close');

        nav.slideToggle(200)

        if (icon.hasClass('.js--mobile-menu-lines')) {
            iconlines.css('display', 'none')
            iconclose.css('display', 'block')
        } else {
            iconlines.css('display', 'block')
